...
2. dieses skript laufen zu lassen und das csv in ein ics file zu konvertieren
3. ics file in einen online calender wie "Proton Calender" zu importieren

# Proton Calendar - ImportFlow

<a href="./Pics/Import_1_create_Cal.jpg" target="_blank">
  <img src="./Pics/Import_1_create_Cal.jpg" width="150" style="margin-right: 10px;"/>
</a>
<a href="./Pics/Import_2_Cal-File_ics.jpg" target="_blank">
  <img src="./Pics/Import_2_Cal-File_ics.jpg" width="150" style="margin-right: 10px;"/>
</a>
<a href="./Pics/Import_3_Progress.jpg" target="_blank">
  <img src="./Pics/Import_3_Progress.jpg" width="150" style="margin-right: 10px;"/>
</a>
